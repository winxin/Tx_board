 ...
 * Board identifier.
 */
#define BOARD_TX_UPLINK_STM32_F103
#define BOARD_NAME              "Tx Uplink board"
 ...
 * PA4  - Push Pull output 50Mhz, set high (NSEL).
 * PA5  - Alternative Push Pull 50Mhz (MOSI, SPI1 to si446x).
 * PA6  - Input pull up (MISO, SPI1 to si446x).
